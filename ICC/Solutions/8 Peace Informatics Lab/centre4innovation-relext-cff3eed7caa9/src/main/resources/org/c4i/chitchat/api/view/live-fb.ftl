    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="m-portlet">
                ...
                <div class="m-portlet__body">
                    <div class="row">
                        <div class="col-12">
                            <p>Use current script as live Facebook script.</p>
                            <p><div id="setLiveBtn" class="btn btn-danger"><i class="la la-flash"></i> Use this script</div></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            <div class="m-portlet">
                ...
                <div class="m-portlet__body" id="connectionInfo">
...
<script>
    ...
    $(document).ready(function () {
        $.hx.setCurrentPage('#menu-item-live-fb')

        const scriptEditor = new CcsEditor($('#scriptEditor')[0], 'demo.ccs')

        const facebookLiveScript = 'Facebook live script';
        ...
        $('#setLiveBtn').click( e => {
          // save under new name
            ...
            $.ajax({
                ...
                contentType: false,
                success: function (a) {
                    $.post('/api/v1/channel/fb/script/reload', function(){
        ...
        $.get('/api/v1/channel/fb/config/info', function(info){
            let $connectionInfo = $('#connectionInfo');
            $connectionInfo.html('');
            for (const conn of info) {
                $connectionInfo
                        .append($.hx.toTable(conn))
                        .append('<hr />');
            }
        })
    })
